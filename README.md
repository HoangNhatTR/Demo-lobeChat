...
| Ollama | Đã cài ([ollama.com](https://ollama.com)) |
...
1. Vào **LobeChat** > tạo phiên mới
2. Bật **Tài liệu nội bộ** (Knowledge Base icon trên toolbar)
3. Upload file PDF
4. Đợi vectorization hoàn tất (biểu tượng xanh)
5. Hỏi câu hỏi liên quan đến nội dung file
